...
const schema = yup.object().shape({
  email: yup.string().email().required('وارد کردن نام کاربری الزامیست'),
  password: yup.string().min(5).required('وارد کردن رمز عبور الزامیست')
})
          ...
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <Box sx={{ my: 6 }}>
              ...
              <Typography sx={{ color: 'text.secondary' }}>
                با وارد کردن نام کاربری و رمز عبور خود، وارد داشبورد شخصی خود شوید
              </Typography>
            </Box>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
                <Typography sx={{ color: 'text.secondary', mr: 2 }}>هنوز حساب کاربری ندارید؟</Typography>
                <Typography component={LinkStyled} href='/register'>
                  از این قسمت ثبت نام کنید
                </Typography>
              </Box>
              <Divider
                sx={{
